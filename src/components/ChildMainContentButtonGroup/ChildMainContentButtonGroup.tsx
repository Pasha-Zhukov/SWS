...
interface ChildMainContentButtonGroupProps {
  itemId: number;
  allData: item[];
...
export const ChildMainContentButtonGroup: React.FC<
  ChildMainContentButtonGroupProps
> = ({ itemId, allData, setAllData, deleteRow }) => {
  return (
    <div className="wrapper-buttons">
      <svg
        onClick={() => createRowLocal(itemId, allData, setAllData)}
